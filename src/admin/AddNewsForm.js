...
const AddNewsForm = ({ onAdd }) => {
  ...
  const sectionsByCategory = {
    'Футбол України': ['УПЛ', 'Збірна України', 'Перша Ліга', 'Друга Ліга', 'Шахтар', 'Динамо Київ', 'Олександрія', 'Кривбас', 'Зоря', 'Чорноморець', 'Оболонь', 'Колос', 'Рух', 'ЛНЗ', 'Карпати', 'Інгулець', 'Ворскла', 'Полісся', 'Лівий Берег', 'Верес'],
    ...
    'Турніри': ['Чемпіонат Світу 2024 з футзалу', 'Клубний чемпіонат світу 2025'],
  };
